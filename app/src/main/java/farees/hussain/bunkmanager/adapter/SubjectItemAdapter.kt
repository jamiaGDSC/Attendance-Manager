...
class SubjectItemAdapter(
    ...
    val onAttend: (Subject) -> Unit,
    val onAbsent: (Subject) -> Unit,
    val onDelete: (Subject) -> Unit
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        when(holder){
            is ViewHolder -> {
                ...
                holder.bind(subjectItem.subject, clickListner, onAttend, onAbsent, onDelete)
            }
        }
    }
    ...
    class TextViewHolder(view: View): RecyclerView.ViewHolder(view) {
        companion object {
            ...
            fun from(parent: ViewGroup): TextViewHolder {
                ...
                view.text.text = "Registered Subjects: "
    ...
    class ViewHolder private constructor(val binding: ItemSubjectsBinding):RecyclerView.ViewHolder(binding.root){
        ...
        fun bind(
            item: Subject,
            clickListner: SubjectItemClickListner,
            onAttend: (Subject) -> Unit,
            onAbsent: (Subject) -> Unit,
...
//                binding.tvPercent.text = "${item.percentageAttendance}%"
            ...
            binding.ivDeleteSubject.setOnClickListener {
                onDelete(item)
            }
        }
